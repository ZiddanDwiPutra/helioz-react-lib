...
export interface OrderSummaryMoleculeProps {
  items: (OrderItemProps & { id: string })[];
  subtotal: number;
  deliveryFee: number;
}

export const OrderSummaryMolecule: React.FC<OrderSummaryMoleculeProps> = ({
  items,
  subtotal,
  deliveryFee
}) => {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <div className="bg-[#1e1e2d] rounded-3xl p-4 border border-slate-800/50">
          {items.map((item) => (
